    ...
    return (
        <AuthLayout user={auth.user}>
            <div className="p-4 bg-white rounded-lg shadow">
                <h2 className="font-medium text-xl mb-6">Data Barang Masuk</h2>
