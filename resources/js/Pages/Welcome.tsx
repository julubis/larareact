...
import { EyeOff, Save } from '@/Components/Icons';
    ...
    return (
        <>
            ...
            <div className="bg-gray-100 pt-20">
                ...
                <button disabled type="button" className="text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 inline-flex items-center">
